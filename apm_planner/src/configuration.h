...
#define QGC_APPLICATION_NAME "UB-ANC Planner"
#define QGC_APPLICATION_VERSION "v0.1"
#define APP_DATA_DIRECTORY "/ub-anc/planner"
#define LOG_DIRECTORY "/dataflashLogs"
#define PARAMETER_DIRECTORY "/parameters"
#define MISSION_DIRECTORY "/missions"
#define SHARE_DIRECTORY "/shares"
...
{
const QString APPNAME = "UB-ANC-PLANNER";
const QString COMPANYNAME = "UB-MCSL";
